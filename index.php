...
for ($i = 1 ; $i != 35 ; $i++){
    if($i == 1 ){
        ...
        $novo = fopen("/home/marcos/Área de Trabalho/Transcritos/aulaP01.txt","a+");
        $final = fopen("/home/marcos/Área de Trabalho/Transcritos/aulaF01.txt","a+");
        $k=0;
        $texto = "";
        $palavras = array();
        ...
        fclose($novo);
        $new = file_get_contents("/home/marcos/Área de Trabalho/Transcritos/aulaP01.txt");
        $ne = explode("|",$new);
